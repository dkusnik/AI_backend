...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.NOTICE("Starting task status sync from Cluster to Frontend"))
        ...
        if dry_run:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"Task sync completed. {count} tasks synchronized.")
            )
