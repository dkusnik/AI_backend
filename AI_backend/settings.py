...
KEYCLOAK_TOKEN_FOR_DEBUG = os.environ.get("KEYCLOAK_TOKEN_FOR_DEBUG", None)
...
EXCLUDED_LOCK_QUEUES = ("task_sync", )
...
WARC2ES_DATA_DIR = os.environ.get("WARC2ES_DATA_DIR", '/srv/ai/browsertrix/warc2es')
